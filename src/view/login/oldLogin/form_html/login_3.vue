            ...
            <div class="input_border_buttom">
                <div class="input_border">
                    ...
                    <div class="clean" v-if="login_data_to_form_widget.form.employee_number.value"
                         onclick="" :click="clickcleanThenNum(login_data_to_form_widget.form.employee_number)">
            ...
            <div class="input_border_buttom">
                <div class="input_border">
                    ...
                    <div class="clean" v-if="login_data_to_form_widget.form.employee_name.value"
                         onclick="" :click="clickcleanThenNum(login_data_to_form_widget.form.employee_name)">
                        <img :attr="{src:clean}" alt=""/>
                    </div>
                </div>
            </div>
            ...
            <div class="input_border_buttom">
                <div class="input_border">
                    ...
                    <div class="clean" v-if="login_data_to_form_widget.form.mobile_phone.value"
                         onclick="" :click="clickcleanThenNum(login_data_to_form_widget.form.mobile_phone)">
                        <img :attr="{src:clean}" alt=""/>
                    </div>
                    <div v-if="auxProperties.mobileInputShow" class="_form_common_input_phone2"
                         onclick="" :click="switchInput">
        ...
        <div class="ip_top">
            <div class="input_border_buttom">
                <div class="sms_input">
                    ...
                    <div v-if="!auxProperties.code_time" class="sms_code"
                         onclick="" :click="clickVerificationCode">获取短信验证码
                    </div>
                </div>
            </div>
            <div class="tip"
